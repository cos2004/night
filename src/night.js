...
function buildNightStyle(config) {
    ...
    elementStyle += 'img,embed,object,iframe,a[class*="icon"],i[class*="icon"],span[class*="icon"],em[class*="icon"],a[class*="logo"],h1[class*="logo"]{-webkit-filter:invert(100%) brightness(0.9) !important;}';
